...
# import motar and pestle to connect with mongoDB
...
MONGO_URL = "mongodb+srv://admin:admin@ashokit-shiva-ai.2yychk4.mongodb.net/?appName=AshokIT-Shiva-AI"
client = AsyncIOMotorClient(MONGO_URL)
db = client["company_db"]  # Define Schema (Rules & Regulations)
collection = db["employees"]  # Define Collection
